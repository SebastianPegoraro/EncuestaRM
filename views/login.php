...
<section>
    <div class="login">
      <div class="container">
        <div class="row">
          <div class="from-group col-md-4 offset-md-4 col-sm-6 offset-sm-3 col-xs-5 offset-xs-5 border border-info" style="background: linear-gradient(-90deg, #003F58, #0089CB);">
              <div class="text-center" id="title-login"><h3>Bienvenido</h3></div>
